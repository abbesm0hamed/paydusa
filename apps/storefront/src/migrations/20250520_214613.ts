...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "pages_blocks_media_content_accordion_items" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "pages_blocks_media_content_accordion" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "pages_blocks_logo_grid_logos" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "pages_blocks_logo_grid" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "pages_blocks_hover_cards_cards" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "pages_blocks_hover_cards" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "pages_blocks_hover_highlights_highlights" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "pages_blocks_hover_highlights" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "pages_blocks_content_grid_links" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "pages_blocks_content_grid_cells" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "pages_blocks_content_grid" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "pages_blocks_card_grid_links" DISABLE ROW LEVEL SECURITY;
  ...
  ALTER TABLE "pages_blocks_callout_imgs" DISABLE ROW LEVEL SECURITY;
  ...
  ALTER TABLE "_pages_v_blocks_media_content_accordion_items" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "_pages_v_blocks_media_content_accordion" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "_pages_v_blocks_logo_grid_logos" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "_pages_v_blocks_logo_grid" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "_pages_v_blocks_hover_cards_cards" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "_pages_v_blocks_hover_cards" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "_pages_v_blocks_hover_highlights_highlights" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "_pages_v_blocks_hover_highlights" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "_pages_v_blocks_content_grid_links" DISABLE ROW LEVEL SECURITY;
  ...
  ALTER TABLE "_pages_v_blocks_card_grid_links" DISABLE ROW LEVEL SECURITY;
  ...
  ALTER TABLE "_pages_v_blocks_callout_imgs" DISABLE ROW LEVEL SECURITY;
  ...
  ALTER TABLE "header_nav_items_group_fields_groups_links" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "header_nav_items_group_fields_groups" DISABLE ROW LEVEL SECURITY;
  ...
  ALTER TABLE "footer_columns_nav_items" DISABLE ROW LEVEL SECURITY;
