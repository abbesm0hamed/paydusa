...
export class Migration20250928072707 extends Migration {
  override async up(): Promise<void> {
    ...
    this.addSql(
      `create table if not exists "invoice_config" ("id" text not null, "company_name" text not null, "company_address" text not null, "company_phone" text not null, "company_email" text not null, "company_logo" text null, "notes" text null, "created_at" timestamptz not null default now(), "updated_at" timestamptz not null default now(), "deleted_at" timestamptz null, constraint "invoice_config_pkey" primary key ("id"));`
    );
    this.addSql(
